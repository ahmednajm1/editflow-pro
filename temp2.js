    ...
    safeBind("btn-capture-frame", function() {
        ...
        csInterface.evalScript('$._editflow.getPlayheadFrameInfo()', function(result) {
            ...
            try {
                ...
                if (r.status !== "success" || !r.mediaPath) {
                ...
                // ffmpeg: Extract frame instantly + Apply color space correction to fix gamma shift
                ...
                var cmd = "export PATH=\"" + binPath + ":/opt/homebrew/bin:/usr/local/bin:$PATH\" && " +
                    ...
                    " -i '" + safeMedia + "'" +
                    " -map 0:v:0 -vframes 1" +
                    " -vf 'colorspace=all=bt709:iall=bt709:fast=1' -color_range pc" +
                    " '" + safePng + "'";
